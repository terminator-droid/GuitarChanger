...
INSERT INTO project.guitars (product_id, model, description, "year", country, pick_ups, fingerboard_wood, media_name)
VALUES ('f02c594a-6902-4e6d-9899-b57e2b49bb71', 'les paul', 'Great Japanese stick', 1990, 'Japan', null, 'Rosewood', null),
       ('4d2f3e65-0b99-4e7b-8eef-74a7359dbdbe', 'pro 2', 'defects on the body', 2000, 'Korea', 'zebra', 'Rosewood', null),
       ('a02d9d96-d257-418f-b166-1f111b55d000', 'telecaster', 'rich sound of a neck', 1970, 'Japan', null, 'Maple', null),
       ('ec29a24f-d5de-458e-a45d-2e7d1616b26f', 'ST-650SPL', 'rare limited edition', 1990, 'Japan', null, 'Alder', null),
       ('d2207ac8-e96e-47e7-b82a-e73ce52ffa6b', 'Axis Super Sport HH', 'Original case included', 2001, 'Korea', null,
        'Rosewood', null),
       ('4be2dc2e-7eb1-4415-a6f7-91ee8ee6d4e7', 'premium plus', 'rare color', 2004, 'USA', 'bb pro', 'Rosewood', null);

INSERT INTO pedals (product_id, model, description, media_name)
VALUES ('8ff99154-93be-4ab6-a3ca-a443ef67c640',  'hyper-metal', 'sounds great', null),
       ('ae7faf36-5561-4314-b083-e2e5f73368e6', 'reptile', 'sounds great', null),
       ('72b6234c-3aa4-4f6d-8df4-7a51f9956fac', 'Amplifier', 'good', null);
